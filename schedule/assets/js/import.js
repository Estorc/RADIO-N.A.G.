...
$.getJSON("https://guillarda.ddns.net/api/week-info", function(json) {
	...
	ScheduleTemplate.prototype.loadEventContent = function(content) {
	    ...
	    self.modal.getElementsByClassName('cd-schedule-modal__event-info')[0].innerHTML = (`<div class="cd-schedule-modal__event-info"><div style='color:black'>${content}</div></div>`); 
